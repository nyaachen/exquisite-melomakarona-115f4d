                ...
                {ALL_TASKS.map((task) => {
                  ...
                  return (
                    <tr key={task.id}>
                      ...
                      <td className="mono" style={{ fontSize: 12 }}>{task.images.toLocaleString()}</td>
                      ...
                      <td style={{ fontSize: 12, color: 'var(--text-secondary)' }}>{task.duration}</td>
                      <td style={{ fontSize: 12 }}>{task.createdAt}</td>
                      <td>
                        <Link to="/tasks/$taskId" params={{ taskId: task.id }} className="btn btn-ghost btn-sm">
