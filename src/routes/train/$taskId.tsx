      ...
      <div className="content-padded">
          ...
          <div className="card card-padded">
            ...
            <div className="progress-info">
              <span className="progress-main">
                {epoch}<span className="progress-sub">/{task.totalEpochs}</span>
              </span>
        ...
        <div className="grid-2 mb-5">
          ...
          <div className="card card-padded" style={{ gridColumn: '1 / -1' }}>
            <div className="chart-title mb-3.5">类别检测性能</div>
              ...
              {task.classes.map((cls, i) => {
                ...
                return (
                  <div key={cls} className="metric-chip">
                    ...
                    <div className="metric-value-lg">{classMap > 0 ? classMap.toFixed(3) : '—'}</div>
                    {classMap > 0 && (
